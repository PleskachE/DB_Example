...
namespace DapperExample.SqlQueries
{
    public class SqlQuery
    {
        ...
        public static string SelectTestsByAuthorId(long authorId) =>
            string.Format(_sqlQueryModel.SelectTestsByAuthor, authorId);

        public static string SelectAuthorByEmail(string authorEmail) =>
            string.Format(_sqlQueryModel.SelectAuthorByEmail, authorEmail);

        public static string SelectAuthorById(long authorId) =>
            string.Format(_sqlQueryModel.SelectAuthorById, authorId);
